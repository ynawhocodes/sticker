...
function App() {
  return (
    <div className='w-full h-full bg-black overflow-hidden'>
      ...
      <StickerPeel imageSrc={hySticker} width={300} rotate={-5} peelBackHoverPct={30} peelBackActivePct={70} shadowIntensity={0.6} lightingIntensity={0.1} initialPosition={{ x: 850, y: 500 }} label='정수이' />
    </div>
  );
}
