...
function App() {
  return (
    <div className='w-full h-full bg-black'>
      ...
      <StickerPeel imageSrc={epSticker} width={300} rotate={5} peelBackHoverPct={30} peelBackActivePct={70} shadowIntensity={0.6} lightingIntensity={0.1} initialPosition={{ x: 50, y: 300 }} label='Everyday Practice' />
    </div>
  );
}
