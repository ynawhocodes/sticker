...
function App() {
  return (
    <div className='w-full h-full bg-black overflow-hidden'>
      <StickerPeel imageSrc={sticker} width={300} rotate={15} peelBackHoverPct={30} peelBackActivePct={70} shadowIntensity={0.6} lightingIntensity={0.05} initialPosition={{ x: 50, y: 100 }} label='양나원' />
